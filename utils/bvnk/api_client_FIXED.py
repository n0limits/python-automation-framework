"""
BVNK API Client (FIXED VERSION)

FIXES APPLIED:
1. Added custom error handling classes
...
# ============================================
# CUSTOM ERROR HANDLING CLASSES (NEW)
# ============================================
...
class BVNKApiClient:
    ...
    def _handle_response(self, response: requests.Response, endpoint: str = "") -> Dict[str, Any]:
        ...
        # FIX: Safely parse JSON with error handling
        try:
    ...
    # ============================================
    # API METHODS (UPDATED TO USE ERROR HANDLING)
    # ============================================
    ...
    def init_account(self) -> Dict[str, Any]:
        ...
        data = self._handle_response(response, endpoint="/init")  # FIXED: Use error handler
    ...
    def echo(self, payload: Optional[Dict] = None) -> Dict[str, Any]:
        ...
        return self._handle_response(response, endpoint="/echo")  # FIXED: Use error handler
    ...
    def list_wallets(self) -> list:
        ...
        return self._handle_response(response, endpoint="/api/wallet")  # FIXED: Use error handler
    ...
    def get_wallet(self, wallet_id: int) -> Dict[str, Any]:
        ...
        wallet = self._handle_response(response, endpoint=f"/api/wallet/{wallet_id}")  # FIXED: Use error handler
    ...
    def create_quote(self, from_currency: str, to_currency: str, amount: float) -> Dict[str, Any]:
        ...
        # FIXED: Error handler will provide detailed context on failure
    ...
    def accept_quote(self, quote_uuid: str) -> Dict[str, Any]:
        ...
        return self._handle_response(response, endpoint=f"/api/v1/quote/accept/{quote_uuid}")  # FIXED
    ...
    def get_quote(self, quote_uuid: str) -> Dict[str, Any]:
        ...
        return self._handle_response(response, endpoint=f"/api/v1/quote/{quote_uuid}")  # FIXED
